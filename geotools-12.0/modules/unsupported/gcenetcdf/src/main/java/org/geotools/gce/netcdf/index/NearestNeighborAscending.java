...
/**
 * A nearest neighbor implementation for the strategy for finding the index of the coordinate value in an ascending coordinate array from a NetCDF
 ...
 * @author Yancy
 */
public class NearestNeighborAscending extends NearestNeighbor {

    private static final Logger LOG = Logging.getLogger(NearestNeighborAscending.class);
    ...
    public int getCoordinateIndex(Array coordArray, double desiredCoord) {
        ...
        int index = (int) Math.round((desiredCoord - firstArrayCoord) / resolution);
