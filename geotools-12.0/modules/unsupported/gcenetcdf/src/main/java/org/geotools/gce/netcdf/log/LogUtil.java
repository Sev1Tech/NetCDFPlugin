...
public class LogUtil {
    ...
    public static void logElapsedTime(Logger logger, Date beginDate, String additionalMessage) {
        ...
        Object[] logMsgObjects = new Object[] { className, methodName, elapsedTime,
                additionalMessage };
